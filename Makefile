##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.9.0-B19] date: [Sun Jul 19 12:09:56 ICT 2026] 
##########################################################################################################################
...
# STM32H5 TinyUSB FSDEV driver
C_SOURCES += $(USB_TINY_DIR)/src/portable/st/stm32_fsdev/dcd_stm32_fsdev.c
C_SOURCES += $(USB_TINY_DIR)/src/portable/st/stm32_fsdev/fsdev_common.c
C_SOURCES += $(USB_TINY_DIR)/src/portable/st/stm32_fsdev/hcd_stm32_fsdev.c
# SYNAPTIX SOURCES
